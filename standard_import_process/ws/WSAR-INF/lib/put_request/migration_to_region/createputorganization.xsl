...
<xsl:stylesheet version="2.0"
            ...
            <env:Body>
                <bsvc:Organization_Add_Update xmlns:bsvc="urn:com.workday/bsvc">
                    ...
                    <bsvc:Organization_Data>
                        ...
                        <xsl:if test="$update.hierarchies = 'yes'">
                            <xsl:apply-templates select="wd:Hierarchy_Data/wd:Included_In_Organization_Reference"/>
                        </xsl:if>
                    </bsvc:Organization_Data>
    ...
    <xsl:template match="wd:Included_In_Organization_Reference">
