        ...
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:bsvc="urn:com.workday/bsvc">
            ...
            <soapenv:Body>
                <bsvc:Get_Workers_Request>
                    ...
                    <xsl:choose>
                        <xsl:when test="$web.service.request.type = 'employee_id_list'">
                    ...
                    <bsvc:Request_Criteria>
                        <xsl:if test="$web.service.request.type = 'transaction_log'
                                or $web.service.request.type = 'transaction_log_termination'">
                        ...
                        <xsl:if test="$web.service.request.type = 'organization' or $web.service.request.type = 'transaction_log'">
                            <xsl:if test="$multi.instance.filter.1.wids != 'no'">
                                <xsl:for-each select="tokenize($multi.instance.filter.1.wids,',')">
                        ...
                        <bsvc:Exclude_Inactive_Workers>
                            <xsl:choose>
                                <xsl:when test="$web.service.request.type = 'transaction_log'">
